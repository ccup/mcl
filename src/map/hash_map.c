...
MCL_PRIVATE MclHashBucketId MclHashMap_GetBucketId(const MclHashMap *self, MclHashKey key) {
...
MclHashMap* MclHashMap_Create(MclSize bucketCount, MclHashNodeAllocator *allocator) {
...
void MclHashMap_Init(MclHashMap *self, MclHashBucket *buckets, MclSize bucketCount, MclHashNodeAllocator *allocator) {
	MCL_ASSERT_VALID_PTR_VOID(self);
...
MclHashNode* MclHashMap_FindNode(const MclHashMap *self, MclHashKey key) {
    ...
    MclHashBucketId bucketId = MclHashMap_GetBucketId(self, key);
...
MclHashValue MclHashMap_FindByPred(const MclHashMap *self, MclHashNodePred pred, void *arg) {
    ...
    for (MclHashBucketId i = 0; i < self->bucketCount; i++) {
...
MclSize MclHashMap_RemoveAllByPred(MclHashMap *self, MclHashNodePred pred, void *arg, MclHashValueDestroy destroy) {
	MCL_ASSERT_VALID_PTR_NIL(self);
	MCL_ASSERT_VALID_PTR_NIL(pred);
